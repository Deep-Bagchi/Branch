...
public class GETAPICall {
    ...
    @Test(priority = 1, description = "Verifying the structure of the response JSON test")
	@Severity(SeverityLevel.BLOCKER)
	@Description("Test Case Description: Verify the structure of the response JSON against the JSON Schema")
	@Story("Story Name: To validate the JSON response structure")
